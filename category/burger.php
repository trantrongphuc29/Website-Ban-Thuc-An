...
$pageTitle = 'Burger - FoodShop';
include INCLUDES_PATH . '/header.php';

// Kết nối database
$conn = getDBConnection();

// Lấy sản phẩm từ bảng burger
$sql = "SELECT * FROM burger ORDER BY created_at DESC";
...
?>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Burger</h1>
            <p>Burger bò, gà, phô mai... cho bữa ăn nhanh gọn, đủ chất.</p>
        </div>
    </section>
    ...
    <section class="category-bar">
        <div class="category-inner">
            ...
            <a class="category-btn active" href="<?php echo CATEGORY_URL; ?>/burger.php">Burger</a>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '                <button class="btn-add" data-id="'. $row['product_id'] .'" data-table="burger">+</button>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</article>';
