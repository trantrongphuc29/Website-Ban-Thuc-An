...
// Trang danh sách Nước uống
$pageTitle = 'Nước uống - FoodShop';
include INCLUDES_PATH . '/header.php';

// Kết nối database
$conn = getDBConnection();

// Lấy sản phẩm từ bảng nuocuong
$sql = "SELECT * FROM nuocuong ORDER BY created_at DESC";
...
?>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Nước uống</h1>
            <p>Các loại nước ngọt, nước ép trái cây tươi mát.</p>
        </div>
    </section>
    ...
    <section class="category-bar">
        <div class="category-inner">
            ...
            <a class="category-btn" href="<?php echo CATEGORY_URL; ?>/ga.php">Gà rán</a>
            ...
            <a class="category-btn active" href="<?php echo CATEGORY_URL; ?>/nuocuong.php">Nước uống</a>
        </div>
    </section>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '        <img src="'. $imgPath .'" alt="'. htmlspecialchars($row['name']) .'" onerror="this.onerror=null; this.src=\''. BASE_URL .'/images/placeholder.jpg\'">';
                    ...
                    echo '                <button class="btn-add" data-id="'. $row['product_id'] .'" data-table="nuocuong">+</button>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</article>';
