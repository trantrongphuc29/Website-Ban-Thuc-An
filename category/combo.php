...
$pageTitle = 'Combo - FoodShop';
include INCLUDES_PATH . '/header.php';

// Kết nối database
$conn = getDBConnection();

// Lấy sản phẩm từ bảng combo
$sql = "SELECT * FROM combo ORDER BY created_at DESC";
...
?>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Combo</h1>
            <p>Các set combo tiết kiệm cho 1 người, 2 người hoặc gia đình.</p>
        </div>
    </section>
    ...
    <section class="category-bar">
        <div class="category-inner">
            ...
            <a class="category-btn active" href="<?php echo CATEGORY_URL; ?>/combo.php">Combo</a>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '        <img src="'. $imgPath .'" alt="'. htmlspecialchars($row['name']) .'" onerror="this.onerror=null; this.src=\''. BASE_URL .'/images/placeholder.jpg\'">';
                    ...
                    echo '                <button class="btn-add" data-id="'. $row['product_id'] .'" data-table="combo">+</button>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</article>';
