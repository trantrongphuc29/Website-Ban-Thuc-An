...
// Trang danh sách món Mì Ý
$pageTitle = 'Mì Ý - FoodShop';
include INCLUDES_PATH . '/header.php';

// Kết nối database
$conn = getDBConnection();

// Lấy sản phẩm từ bảng miy
$sql = "SELECT * FROM miy ORDER BY created_at DESC";
...
?>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Mì Ý</h1>
            <p>Mì Ý sốt bò bằm, kem, phô mai thơm béo.</p>
        </div>
    </section>
    ...
    <section class="category-bar">
        <div class="category-inner">
            ...
            <a class="category-btn active" href="<?php echo CATEGORY_URL; ?>/miy.php">Mì Ý</a>
        ...
        <div class="product-grid">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '        <img src="'. $imgPath .'" alt="'. htmlspecialchars($row['name']) .'" onerror="this.onerror=null; this.src=\''. BASE_URL .'/images/placeholder.jpg\'">';
                    ...
                    echo '                <button class="btn-add" data-id="'. $row['product_id'] .'" data-table="miy">+</button>';
                    echo '            </div>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</article>';
