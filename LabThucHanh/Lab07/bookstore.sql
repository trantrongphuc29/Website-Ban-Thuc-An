...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 03, 2025 at 04:47 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `capnhat` (IN `book_id` VARCHAR(15), IN `new_price` FLOAT)   BEGIN
    UPDATE sach
    SET gia = new_price
    WHERE masach = book_id;
END$$

DROP PROCEDURE IF EXISTS `lietke`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `lietke` (IN `category_code` VARCHAR(5))   BEGIN
...
INSERT INTO `admin` (`usertenkh`, `matkhau`, `tenkh`, `email`, `dienthoai`) VALUES
...
CREATE TABLE IF NOT EXISTS `chitiethd` (
  ...
  `masach` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `soluong` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `hoadon` (
  ...
  `tennguoinhan` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `diachinguoinhan` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `dienthoainguoinhan` varchar(12) NOT NULL DEFAULT '',
  `trangthai` int NOT NULL DEFAULT '0' COMMENT 'Trạng thái:0-3',
  PRIMARY KEY (`mahd`),
  KEY `email` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `khachhang` (
  `email` varchar(50) NOT NULL DEFAULT '',
  `matkhau` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `dienthoai` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `loai` (
  `maloai` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `hinh` varchar(50) DEFAULT NULL COMMENT 'path file hình',
...
INSERT INTO `news` (`id`, `title`, `hinh`, `short_content`, `content`, `hot`) VALUES
(1, 'qqq', 'q', 'q', 'q', 0),
(2, 'ww', 'w', 'w', 'w', 1),
(3, 'ee', 'e', 'e', 'e', 1);
...
CREATE TABLE IF NOT EXISTS `nhaxb` (
  `manxb` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `tennxb` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  PRIMARY KEY (`manxb`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `sach` (
  `masach` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `tensach` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
--
-- Stand-in structure for view `top_10_ban_chay`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `top_10_ban_chay`;
CREATE TABLE IF NOT EXISTS `top_10_ban_chay` (
`masach` varchar(15)
,`tensach` varchar(250)
,`tongsoluong` decimal(25,0)
);
...
DROP VIEW IF EXISTS `top_10`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `top_10`  AS SELECT `sach`.`masach` AS `masach`, `sach`.`tensach` AS `tensach`, `sach`.`gia` AS `gia` FROM `sach` ORDER BY `sach`.`gia` DESC LIMIT 0, 10 ;

-- --------------------------------------------------------

--
-- Structure for view `top_10_ban_chay`
--
DROP TABLE IF EXISTS `top_10_ban_chay`;

DROP VIEW IF EXISTS `top_10_ban_chay`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `top_10_ban_chay`  AS SELECT `s`.`masach` AS `masach`, `s`.`tensach` AS `tensach`, sum(`ct`.`soluong`) AS `tongsoluong` FROM (`chitiethd` `ct` join `sach` `s` on((`ct`.`masach` = `s`.`masach`))) GROUP BY `s`.`masach`, `s`.`tensach` ORDER BY `tongsoluong` DESC LIMIT 0, 10 ;
